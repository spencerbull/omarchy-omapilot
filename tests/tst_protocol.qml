...
TestCase {
  ...
  function test_voiceCatalogNormalizesProvidersAndCloudKeys() {
    ...
    compare(Protocol.normalizedVoiceVisualizer("KITT"), "")
    compare(Protocol.normalizedVoiceVisualizer("Bumper"), "")
    ...
    compare(Protocol.voiceVisualizerOptions().length, 4)
    compare(Protocol.voiceVisualizerOptions()[0].value, "segments")
    compare(Protocol.voiceVisualizerOptions()[0].label, "Segments")
    compare(Protocol.voiceVisualizerOptions()[3].value, "line")
    compare(Protocol.normalizedThinkingVisualizer("Scanner"), "scanner")
    compare(Protocol.normalizedThinkingVisualizer("BUMPER"), "bumper")
    compare(Protocol.normalizedThinkingVisualizer("unknown"), "")
    compare(Protocol.thinkingVisualizerOptions().length, 2)
    compare(Protocol.thinkingVisualizerOptions()[0].value, "scanner")
    compare(Protocol.thinkingVisualizerOptions()[1].value, "bumper")
